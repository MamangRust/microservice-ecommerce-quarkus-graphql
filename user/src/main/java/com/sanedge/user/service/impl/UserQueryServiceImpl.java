        ...
        public Uni<ApiResponsePagination<List<UserResponse>>> findAllPaginated(FindAllUsers request) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        return tracingMetrics.traceAndMeasure("findAllUsers", "find_all_users",
                                                        Attributes.builder()
        ...
        public Uni<ApiResponsePagination<List<UserResponseDeleteAt>>> findActivePaginated(FindAllUsers request) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        return tracingMetrics.traceAndMeasure("findActiveUsers", "find_active_users",
                                                        Attributes.builder()
                                                                        .put("user.page", request.getPage())
                                                                        .put("user.size", request.getPageSize())
                                                                        .build(),
        ...
        public Uni<ApiResponsePagination<List<UserResponseDeleteAt>>> findTrashedPaginated(FindAllUsers request) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        return tracingMetrics.traceAndMeasure("findTrashedUsers", "find_trashed_users",
                                                        Attributes.builder()
                                                                        .put("user.page", request.getPage())
                                                                        .put("user.size", request.getPageSize())
                                                                        .build(),
        ...
        public Uni<ApiResponse<UserResponse>> findById(Long id) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        return tracingMetrics.traceAndMeasure("findUserById", "find_user_by_id",
                                                                                ...
                                                                                return redisService.setReactive(
                                                                                                ...
                                                                                                .map(v -> {
                                                                                                        logger.info("Cached user for key: {}",
                                                                                                                        cacheKey);
                                                                                                        logger.info(
                                                                                                                        "Successfully found user with id: {} and username: {}",
                                                                                                                        id,
                                                                                                                        user.getUsername());
                                                                                                        return ApiResponse
                                                                                                                        .success("User found",
