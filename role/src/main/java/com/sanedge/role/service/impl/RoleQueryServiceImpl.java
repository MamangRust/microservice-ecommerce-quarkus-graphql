...
public class RoleQueryServiceImpl implements RoleQueryService {
        ...
        public RoleQueryServiceImpl(RoleRepository roleRepository, RedisService redisService,
                        TracingMetrics tracingMetrics, ObjectMapper objectMapper) {
        ...
        public Uni<ApiResponsePagination<List<RoleResponse>>> findAllPaginated(FindAllRoles request) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        return tracingMetrics.traceAndMeasure("findAllRoles", "find_all_roles",
                                                        Attributes.builder()
        ...
        public Uni<ApiResponsePagination<List<RoleResponseDeleteAt>>> findActivePaginated(FindAllRoles request) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        return tracingMetrics.traceAndMeasure("findActiveRoles", "find_active_roles",
                                                        Attributes.builder()
                                                                        .put("role.page", request.getPage())
                                                                        .put("role.size", request.getPageSize())
                                                                        .build(),
        ...
        public Uni<ApiResponsePagination<List<RoleResponseDeleteAt>>> findTrashedPaginated(FindAllRoles request) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        return tracingMetrics.traceAndMeasure("findTrashedRoles", "find_trashed_roles",
                                                        Attributes.builder()
                                                                        .put("role.page", request.getPage())
                                                                        .put("role.size", request.getPageSize())
                                                                        .build(),
        ...
        public Uni<ApiResponse<RoleResponse>> findById(Long id) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        return tracingMetrics.traceAndMeasure("findRoleById", "find_role_by_id",
                                                                                ...
                                                                                return redisService.setReactive(
                                                                                                ...
                                                                                                .map(v -> {
                                                                                                        logger.info("Cached role for key: {}",
                                                                                                                        cacheKey);
                                                                                                        logger.info(
                                                                                                                        "Successfully found role with id: {} and name: {}",
                                                                                                                        id,
                                                                                                                        role.getRoleName());
                                                                                                        return ApiResponse
                                                                                                                        .success("Role found",
        ...
        public Uni<ApiResponse<List<RoleResponse>>> findByUserId(Long userId) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        return tracingMetrics.traceAndMeasure("findRolesByUserId",
                                                        "find_role_by_user_id",
                                                        Attributes.builder().put("user.id", userId.toString()).build(),
        ...
        public Uni<ApiResponse<RoleResponse>> findByName(String name) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        return tracingMetrics.traceAndMeasure("findRoleByName", "find_role_by_name",
                                                        Attributes.builder().put("role.name", name).build(),
